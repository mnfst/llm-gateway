...
See the [CLI documentation](https://docs.manifest.build/cli/) for more examples and the [GitHub repository](https://github.com/mnfst/llm-gateway) for source and issues.
